...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        UPDATE "docs"
        SET "parent_id" = (SELECT "id" FROM "docs" WHERE "urlpath" = '' AND "parent_id" IS NULL)
        WHERE "parent_id" IS NULL AND "urlpath" != '';"""
...
async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        UPDATE "docs"
        SET "parent_id" = NULL
        WHERE "parent_id" = (SELECT "id" FROM "docs" WHERE "urlpath" = '' AND "parent_id" IS NULL);"""
